...
def deformerWeights(attribute: str = "",defaultValue: float = 1.0,deformer: str = "",export: bool = False,ignoreName: bool = False,im: bool = False,method: str = "",path: str = "",positionTolerance: float = 1.0,remap: str = "",shape: str = "",skip: str = "",vertexConnections: bool = False,weightPrecision: int = 1,weightTolerance: float = 1.0,worldSpace: bool = False) -> None:
    """
