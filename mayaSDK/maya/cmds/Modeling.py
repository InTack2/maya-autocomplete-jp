...
def polyDuplicateEdge(adjustEdgeFlow: float = 1.0,deleteEdge: bool = False,endVertexOffset: float = 1.0,insertWithEdgeFlow: bool = False,offset: float = 1.0,smoothingAngle: float = 1.0,splitType: int = 1,startVertexOffset: float = 1.0,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1) -> None:
    """
...
def polyNormalizeUV(centerOnTile: bool = False,normalizeDirection: int = 1,normalizeType: int = 1,preserveAspectRatio: bool = False,caching: bool = False,constructionHistory: bool = False,createNewMap: bool = False,insertBeforeDeformers: bool = False,name: str = "",nodeState: int = 1,uvSetName: str = "",worldSpace: bool = False) -> None:
    """
...
def polyPlane(axis: Tuple[float, float, float] = tuple(1.0, 1.0, 1.0),createUVs: int = 1,height: float = 1.0,subdivisionsHeight: int = 1,subdivisionsWidth: int = 1,subdivisionsX: int = 1,subdivisionsY: int = 1,texture: int = 1,width: float = 1.0,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1,object: bool = False) -> None:
    """
    新しいポリゴン プレーンを作成します。
...
def polyPrimitive(axis: Tuple[float, float, float] = tuple(1.0, 1.0, 1.0),createUVs: int = 1,polyType: int = 1,radius: float = 1.0,sideLength: float = 1.0,texture: int = 1,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1,object: bool = False) -> None:
    """
    ポリゴン プリミティブを作成します
...
def polyRemesh(caching: bool = False,constructionHistory: bool = False,interpolationType: int = 1,name: str = "",nodeState: int = 1,reduceThreshold: float = 1.0,refineThreshold: float = 1.0,smoothStrength: float = 1.0,tessellateBorders: bool = False) -> None:
    """
    ...
    reduceThreshold (float): refineThresholdのパーセンテージです。このパーセンテージよりも短いエッジは、単一頂点に削減されます。

    -----------------------------------------

    refineThreshold (float): この値よりも長い三角形のエッジが2つに分割されます。
...
def polyRetopoCtx() -> None:
    """
    ノードの再作成を操作するための新しいコンテキストを作成します。
...
def polySphere(axis: Tuple[float, float, float] = tuple(1.0, 1.0, 1.0),createUVs: int = 1,radius: float = 1.0,subdivisionsAxis: int = 1,subdivisionsHeight: int = 1,subdivisionsX: int = 1,subdivisionsY: int = 1,texture: int = 1,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1,object: bool = False) -> None:
    """
...
def polySplitEdge(operation: int = 1,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1) -> None:
    """
    エッジを分割します。
...
def polySubdivideFacet(divisions: int = 1,divisionsU: int = 1,divisionsV: int = 1,mode: int = 1,subdMethod: int = 1,caching: bool = False,constructionHistory: bool = False,name: str = "",nodeState: int = 1) -> None:
    """
